 ...
 */
package org.openhab.binding.mercedes.internal.api;
...
import org.openhab.binding.mercedes.internal.api.exception.MercedesTokenExpiredException;
...
/**
 * Class to handle Mercedes Web Api calls.
 *
...
public class MercedesApi {
    ...
    private final Logger logger = LoggerFactory.getLogger(MercedesApi.class);

    private final OAuthClientService oAuthClientService;
    private final MercedesConnector connector;

    /**
     * Constructor.
     *
     * @param authorizer The authorizer used to refresh the access token when expired
     * @param connector The Mercedes connector handling the Web Api calls to Mercedes
     */
    public MercedesApi(OAuthClientService oAuthClientService, ScheduledExecutorService scheduler,
            HttpClient httpClient) {
        this.oAuthClientService = oAuthClientService;
        connector = new MercedesConnector(scheduler, httpClient);
    }

    // /**
    // * @return Returns the Mercedes user information
    // */
    // public Me getMe() {
    ...
    // /**
    // * Call Mercedes Api to play the given track on the given device. If the device id is empty it will be played on
    // * the active device.
    // *
    ...
    // /**
    // * Call Mercedes Api to start playing. If the device id is empty it will start play of the active device.
    // *
    // * @param deviceId device to play on or empty if play on the active device
    // */
    ...
    // /**
    // * Call Mercedes Api to transfer playing to. Depending on play value is start play or pause.
    // *
    ...
    // /**
    // * Call Mercedes Api to pause playing. If the device id is empty it will pause play of the active device.
    // *
    ...
    // /**
    // * Call Mercedes Api to play the next song. If the device id is empty it will play the next song on the active
    // * device.
    // *
    ...
    // /**
    // * Call Mercedes Api to play the previous song. If the device id is empty it will play the previous song on the
    // * active device.
    // *
    ...
    // /**
    // * Call Mercedes Api to play set the volume. If the device id is empty it will set the volume on the active
    // device.
    // *
    ...
    // /**
    // * Call Mercedes Api to play set the repeat state. If the device id is empty it will set the repeat state on the
    // * active device.
    // *
    // * @param deviceId device to set repeat state on or empty if set repeat on the active device
    // * @param repeateState set the mercedes repeat state
    // */
    ...
    // /**
    // * Call Mercedes Api to play set the shuffle. If the device id is empty it will set shuffle state on the active
    // * device.
    // *
    ...
    // /**
    // * @return Calls Mercedes Api and returns the list of device or an empty list if nothing was returned
    // */
    ...
    // /**
    // * @return Calls Mercedes Api and returns the current playing context of the user or an empty object if no context
    // as
    // * returned by Mercedes
    // */
    ...
    // /**
    // * Calls the Mercedes player Web Api with the given method and appends the given url as parameters of the call to
    // * Mercedes.
    // *
    // * @param method Http method to perform
    // * @param url url path to call to mercedes
    // * @return the response give by Mercedes
    // */
    ...
    /**
     * Calls the Mercedes Web Api with the given method and given url as parameters of the call to Mercedes.
     *
     * @param method Http method to perform
     * @param url url path to call to mercedes
     * @param requestData data to pass along with the call as content
    ...
    private ContentResponse request(HttpMethod method, String url, String requestData) {
        ...
        try {
            ...
            if (accessToken == null || accessToken.isEmpty()) {
                throw new MercedesAuthorizationException(
                        "No mercedes accesstoken. Did you authorize mercedes via /connectmercedes ?");
            } else {
    ...
    private ContentResponse requestWithRetry(final Function<HttpClient, Request> call, final String accessToken)
        ...
        } catch (MercedesTokenExpiredException e) {
